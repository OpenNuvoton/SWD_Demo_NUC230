...
#include "NUC230_240.h"                         // Debug Unit Cortex-M Processor Header File
...
{
    GPIO_SetMode(PIN_SWCLK_PORT, (1 << PIN_SWCLK_BIT), GPIO_PMD_OUTPUT);
    GPIO_SetMode(PIN_SWDIO_PORT, (1 << PIN_SWDIO_BIT), GPIO_PMD_OUTPUT);
    GPIO_SetMode(PIN_nRESET_PORT, (1 << PIN_nRESET_BIT), GPIO_PMD_OUTPUT);
...
{
    GPIO_SetMode(PIN_SWCLK_PORT, (1 << PIN_SWCLK_BIT), GPIO_PMD_INPUT);
    GPIO_SetMode(PIN_SWDIO_PORT, (1 << PIN_SWDIO_BIT), GPIO_PMD_INPUT);
    GPIO_SetMode(PIN_nRESET_PORT, (1 << PIN_nRESET_BIT), GPIO_PMD_INPUT);
}
